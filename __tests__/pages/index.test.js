...
jest.mock('@chakra-ui/react', () => {
  ...
  return {
    Container: ({ children, ...allProps }) => {
      ...
      return React.createElement(
        'div',
        { 'data-testid': 'container', ...domProps },
        children
      )
    },
    ...
    ListItem: ({ children, ...allProps }) => {
      ...
      return React.createElement(
        'li',
        { 'data-testid': 'list-item', ...domProps },
        children
      )
    }
  }
...
jest.mock('@chakra-ui/icons', () => ({
  ChevronRightIcon: () =>
    React.createElement('span', { 'data-testid': 'chevron-right-icon' }, '→')
}))

jest.mock('../../components/bio', () => ({
  BioSection: ({ children }) =>
    React.createElement('div', { 'data-testid': 'bio-section' }, children),
  BioYear: ({ children }) =>
    React.createElement('span', { 'data-testid': 'bio-year' }, children)
}))

jest.mock('react-icons/io5', () => ({
  IoLogoLinkedin: () =>
    React.createElement('span', { 'data-testid': 'linkedin-icon' }, 'LI'),
  IoLogoGithub: () =>
    React.createElement('span', { 'data-testid': 'github-icon' }, 'GH')
}))

jest.mock('react-icons/md', () => ({
  MdEmail: () =>
    React.createElement('span', { 'data-testid': 'email-icon' }, '@')
}))
